describe('Проверка покупки нового аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[id="k_email"]').type('eremina-mari@yandex.ru');                   // вводим логин
         cy.get('input[id="k_password"]').type('Erbakc1808RD');               // вводим пароль
         ...
         cy.get('.card_name').type('MARIYA EREMINA');                           // вводим имя владельца действия карты
